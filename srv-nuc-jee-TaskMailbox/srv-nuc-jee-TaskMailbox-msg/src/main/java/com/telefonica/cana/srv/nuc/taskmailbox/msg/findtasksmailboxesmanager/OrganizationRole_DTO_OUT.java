 ...
 *         &lt;element name="Organization" type="{http://telefonica.com/cana/srv/TaskMailbox/msg/findTasksMailBoxesManager-v3}Organization_DTO_OUT"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "OrganizationRole_DTO_OUT", propOrder = { "id", "organization" })
public class OrganizationRole_DTO_OUT implements Serializable {
    ...
    @NotNull
    @Valid
    protected Organization_DTO_OUT organization;
     ...
     * @return
     *     possible object is
     *     {@link Organization_DTO_OUT }
     *     
     */
    public Organization_DTO_OUT getOrganization() {
        return organization;
    }
     ...
     *     
     */
    public void setOrganization(Organization_DTO_OUT value) {
