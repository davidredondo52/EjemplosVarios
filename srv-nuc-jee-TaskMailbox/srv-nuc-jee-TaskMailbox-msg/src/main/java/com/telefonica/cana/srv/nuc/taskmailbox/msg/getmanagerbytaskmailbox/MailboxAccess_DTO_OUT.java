 ...
 *         &lt;element name="FunctionalRole" type="{http://telefonica.com/cana/srv/TaskMailbox/msg/getManagerByTaskMailbox-v3}FunctionalRole_DTO_OUT"/&gt;
...
@XmlType(name = "MailboxAccess_DTO_OUT", propOrder = { "id", "functionalRole", "mailboxAccess", "mailboxResponsible" })
public class MailboxAccess_DTO_OUT implements Serializable {
    ...
    @XmlElement(name = "FunctionalRole", required = true)
    @NotNull
    @Valid
    protected FunctionalRole_DTO_OUT functionalRole;
    ...
    /**
     * Obtiene el valor de la propiedad functionalRole.
     * 
     * @return
     *     possible object is
     *     {@link FunctionalRole_DTO_OUT }
     *     
     */
    public FunctionalRole_DTO_OUT getFunctionalRole() {
        return functionalRole;
    }

    /**
     * Define el valor de la propiedad functionalRole.
     * 
     * @param value
     *     allowed object is
     *     {@link FunctionalRole_DTO_OUT }
     *     
     */
    public void setFunctionalRole(FunctionalRole_DTO_OUT value) {
