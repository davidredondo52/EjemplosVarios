...
public class MultiLanguageList implements Serializable {
    ...
    public void setMultiLanguages(MultiLanguageList.MultiLanguage[] values) {
        ...
        this.multiLanguages = ((MultiLanguageList.MultiLanguage[]) new com.telefonica.cana.srv.nuc.taskmailbox.msg.findtaskmailbox.MultiLanguageList.MultiLanguage[len]);
        for (int i = 0; (i < len); i++) {
