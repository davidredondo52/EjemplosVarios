 ...
 * 
 * <p>Clase Java para DistributionCriteria_DTO_IN complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="DistributionCriteria_DTO_IN"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DistributionCriteria_DTO_IN", propOrder = { "id" })
public class DistributionCriteria_DTO_IN implements Serializable {
